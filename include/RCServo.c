...
//
//extern unsigned char rc_PL1;
//extern unsigned char rc_PL2;
//extern unsigned char rc_PL3;
//extern unsigned char rc_PL4;
//
//static unsigned int prevPulse = 0;
//static unsigned int nextPulse = 0;
//
...
//    unsigned char* SERVO = (unsigned char*) theshit;
//    rc_PL1 = ((unsigned int) SERVO[0]);
//    rc_PL2 = ((unsigned int) SERVO[1]);
//    rc_PL3 = ((unsigned int) SERVO[2]);
//    rc_PL4 = ((unsigned int) SERVO[3]);
//    if (prevPulse != OC3RS) {
...
//
//    } else {
//        RCServo_SetPulse(((rc_PL1 << 24) | (rc_PL2 << 16) | (rc_PL3 << 8) | rc_PL4)); // scaling it to an unsigned int
//    }
//}
//
//#ifdef RC_SERVO_TEST
...
//
//        // flag = 0;
//        //  while (Protocol_IsMessageAvailable() == FALSE);
...
//                            asm("nop");
//                        }
//                        if (thisPulse != output.z) {
//                            Protocol_SendMessage(4, ID_SERVO_RESPONSE, &(output.z));
//                            //   Protocol_Init();
//                        }
//                        for (int i = 0; i < 100; i++) {
//                            asm("nop");
